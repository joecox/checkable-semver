...
distributed development over the internet. Package managers like {\tt
  cpan} \marktodo{}{cite} for Perl, {\tt npm} for Node/JS \marktodo{}{cite},
and {\tt Maven} for Java \marktodo{}{cite} tackle logistical problems --
...
domains and languages \marktodo{cite some specification languages},
