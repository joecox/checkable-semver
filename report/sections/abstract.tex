...
%
  However, the state of the practice is limited by the absence of
  clear module interface specifications.
%
  A client may mistakenly rely upon API secrets, or a module author
...
%
  ...
  We fill this gap by devising a new test-based discipline for define
  module interface specifications, along with a {\em cross-version
    testing} approach that uses interface tests to detect Semantic
  Versioning. 
%
...
%
  ...
  there some investment is required from the module authors to adopt
  our discipline. 
\end{abstract}
