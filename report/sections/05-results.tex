...
\begin{figure*}
\centering
\includegraphics[height=50ex]{graphics/violations-jsapi-plt}
...
\begin{figure*}
\centering
\includegraphics[height=50ex]{graphics/cumulative-jsapi-plt}
...
\todo{Hypothesis: density of violations in test-jsapi should be less
  than the density in test-all. Confirm or reject in evaluation.}
