...
incompatible versions of a third module. \todo{A figure depicting dep
  hell would be nice here. Something like ``Program contains modules A
  and B. A depends on C version 1.X, B depends on C version 2.X''}{}
%
...
tools that can automatically check SemVer compliance, or recommend
...
implementation and a specification. A release is a tuple of a version number,
